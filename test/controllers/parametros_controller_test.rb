...
class ParametrosControllerTest < ActionController::TestCase
  ...
  test "should create parametro" do
    assert_difference('Parametro.count') do
      post :create, parametro: { entidad_id: @parametro.entidad_id, texto: @parametro.texto, valor: @parametro.valor }
    end
  ...
  test "should update parametro" do
    patch :update, id: @parametro, parametro: { entidad_id: @parametro.entidad_id, texto: @parametro.texto, valor: @parametro.valor }
    assert_redirected_to parametro_path(assigns(:parametro))
  end
