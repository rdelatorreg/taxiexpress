...
class RatesControllerTest < ActionController::TestCase
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post :create, rate: { destination_id: @rate.destination_id, origin_id: @rate.origin_id, price: @rate.price }
    end
  ...
  test "should update rate" do
    patch :update, id: @rate, rate: { destination_id: @rate.destination_id, origin_id: @rate.origin_id, price: @rate.price }
    assert_redirected_to rate_path(assigns(:rate))
  end
